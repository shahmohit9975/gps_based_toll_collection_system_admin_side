		...
		<div class="topbar">
			...
			<div class="topbar-left">
				<div class="text-center">
					<a href="manage_toll.jsp" class="logo">Toll
						Authority</a>
				</div>
			</div>
			<!-- End Logo -->
							...
							<div class="panel">
								<div class="panel-body">
									...
									<div class="product-title-box">
										<h4 class="page-title m-t-20">Reset Password</h4>
									</div>

									<div class="m-t-30">
										<form action="toll_authority_reset_password" method="post">
											<table class="table table-bordered m-t-30"
												style="width: 50%;">
												<thead class="thead-dark">
													<tr style="background-color: #f5f5f0;">
														<th scope="col"><input type="password"
															placeholder="ENTER NEW PASSWORD" name="reset_password"
											...
											<table class="table table-bordered m-t-30"
												...
												<thead class="thead-dark">
													...
													<tr style="background-color: #e0e0d1;">
														...
														<th scope="col"><input type="submit" value="RESET"
															style="width: 100%;"></th>
													</tr>
												</thead>
