...
<title>Toll Collector Change Password</title>
				...
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown user-box"><a href="#"
							...
							aria-expanded="false">
								<h5 style="color: red;">
									<b>${sessionScope.toll_collector}</b>
								</h5>
						</a>
				...
				<div class="user-panel" id="sidebar-menu">
					<ul>
						<li class="has_sub"><a href="toll_collector_home_page.jsp"><i
								class="mdi mdi-bus-school"></i><span>Change Password</span></a></li>
							...
							<div class="panel">
								<div class="panel-body">
									...
									<div class="product-title-box">
										<h4 class="page-title m-t-20">Change Password</h4>
									</div>

									<div class="m-t-30">
										<form action="toll_collector_update_password" method="post">
